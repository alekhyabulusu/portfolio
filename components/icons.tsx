...
function BrandIcon({ size = 22, children, ...props }: IconProps & { children: ReactNode }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export const FlaskConical = (p: IconProps) => (
  <LineIcon {...p}>
    <path d="M14 2v6.343a2 2 0 0 0 .293 1.043l5.414 8.657A2 2 0 0 1 18 21H6a2 2 0 0 1-1.707-3l5.414-8.657A2 2 0 0 0 10 8.343V2" />
...
export const MailFilled = (p: IconProps) => (
  <BrandIcon {...p}>
